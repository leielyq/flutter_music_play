...
class MyTabIndicator extends Decoration {
  ...
  const MyTabIndicator( {
    ...
    this.showUnline = true,
  })  : assert(borderSide != null),
        assert(insets != null);

  final bool showUnline;
  final Color color;
  ...
  _UnderlinePainter createBoxPainter([VoidCallback onChanged]) {
    return _UnderlinePainter(this, onChanged, showUnline,color);
  }
}
...
class _UnderlinePainter extends BoxPainter {
  ...
  _UnderlinePainter(this.decoration, VoidCallback onChanged, this.showUnline, this.color)
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    Rect rectContext = Rect.fromCenter(
        center: rect.center,
        width: indicator.width + 20,
        height: rect.height / 1.5);
    RRect rrect =
        RRect.fromRectAndRadius(rectContext, Radius.circular(rect.height / 3));
